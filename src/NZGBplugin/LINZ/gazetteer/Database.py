...
def setConnection( host=None, port=None, database=None, schema=None, user=None, password=None ):
    ...
    if changed and _instance:
        raise RuntimeError('Cannot set connection to database after it has been instantiated')
