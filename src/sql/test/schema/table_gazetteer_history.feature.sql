...
SELECT col_type_is(      'gazetteer_history', 'feature', 'ref_point', 'geometry(Point,4167)', 'Column gazetteer_history.feature.ref_point should be type geometry(Point,4167)');
